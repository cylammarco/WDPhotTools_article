...
described in \textsection3 to \textsection6 alongside with the usage of those
classes and modules.} We summarise this work in \textsection7.
...
\textcolor{red}{with the \texttt{extinction}
...
Therefore, we convolve the filter profile with the DA
