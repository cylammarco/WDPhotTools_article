...
if os.path.exists("wdlf_5Gyr_compare_ifmr.npy"):
    ...
    print('Loaded 5 Gyr WDLFs.')
    wdlf_5Gyr = np.load("wdlf_5Gyr_compare_ifmr.npy")

else:

    print('Computing 5 Gyr WDLFs.')
...
if os.path.exists("wdlf_7Gyr_compare_ifmr.npy"):

    print('Loaded 7 Gyr WDLFs.')
    wdlf_7Gyr = np.load("wdlf_7Gyr_compare_ifmr.npy")

else:

    print('Computing 7 Gyr WDLFs.')
...
if os.path.exists("wdlf_9Gyr_compare_ifmr.npy"):

    print('Loaded 9 Gyr WDLFs.')
    wdlf_9Gyr = np.load("wdlf_9Gyr_compare_ifmr.npy")

else:

    print('Computing 9 Gyr WDLFs.')
...
if os.path.exists("wdlf_11Gyr_compare_ifmr.npy"):

    print('Loaded 11 Gyr WDLFs.')
    wdlf_11Gyr = np.load("wdlf_11Gyr_compare_ifmr.npy")

else:

    print('Computing 11 Gyr WDLFs.')
...
if os.path.exists("wdlf_13Gyr_compare_ifmr.npy"):

    print('Loaded 13 Gyr WDLFs.')
    wdlf_13Gyr = np.load("wdlf_13Gyr_compare_ifmr.npy")

else:

    print('Computing 13 Gyr WDLFs.')
...
if os.path.exists("wdlf_15Gyr_compare_ifmr.npy"):

    print('Loaded 15 Gyr WDLFs.')
    wdlf_15Gyr = np.load("wdlf_15Gyr_compare_ifmr.npy")

else:

    print('Computing 15 Gyr WDLFs.')
...
ax1.set_ylabel("log(number density)")
ax2.set_ylabel(r"log(n/n$_{C08}$)")
ax4.set_ylabel("log(number density)")
ax5.set_ylabel(r"log(n/n$_{C08}$)")
ax7.set_ylabel("log(number density)")
...
plt.savefig("fig_10_wdlf_compare_ifmr.png")
plt.savefig("fig_10_wdlf_compare_ifmr.pdf")
